...
class Dataset_Both_ES(Dataset): 
    ...
    def __getitem__(self, index):
        ...
        #temp_SA = generate_label_(img_SA_gt,org_dim3)
        
        temp_SA = same_depth(temp_SA)
        ...
        return img_LA,temp_LA[:,0,:,:],img_SA,temp_SA,self.images_name[index],V,S,D
...
simple_dataset1 = Dataset_Both_ED(df_val,val_imgs)
simple_dataset2 = Dataset_Both_ES(df_val,val_imgs)


dataset = ConcatDataset([simple_dataset1, simple_dataset2])
...
for fold, (train_ids, valid_ids) in enumerate(kfold.split(dataset)):
    ...
    valid_loader = DataLoader(dataset, batch_size=1, sampler=valid_subsampler)
    
    print(len(train_loader))
    print(len(valid_loader))
    
    
# for fold, (train_ids, valid_ids) in enumerate(kfold.split(simple_dataset1)):
#     print(f'FOLD {fold}')
#     print('--------------------------------')
#     train_subsampler = SubsetRandomSampler(train_ids)
#     valid_subsampler = SubsetRandomSampler(valid_ids)
    
#     train_loader = DataLoader(simple_dataset1, batch_size=1, sampler=train_subsampler)
#     valid_loader = DataLoader(simple_dataset1, batch_size=1, sampler=valid_subsampler)
...
for i in range(20):
    ...
    plt.figure()
    plt.imshow(a1[0].numpy()[0,0,:,:])
    

img_path = r'C:\My_Data\M2M Data\data\val\197\197'
